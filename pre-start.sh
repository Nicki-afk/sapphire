...
read -p "Write directory Tomcat in which you want install application : " tomacat_directory



# Request confirmation
# Запрашиваем потверждение 
read -p "Are you sure you want to replace the $line_to_change string with \"$tomacat_directory\"? (y/n):" confirm
if [ "$confirm" != "y" ]; then
...
sed -i "${line_to_change}s#.*#$tomacat_directory#" "$pom_file"
