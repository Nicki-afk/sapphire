...
public class UserRepositoryTest {
        ...
        void testFindByCryptoWalletAddress(User user) {
                ...
                assertTrue((userToSaveTest.equals(userToGetTest)));
                assertTrue(
                                (userToSaveTest.getCryptoWalletAddress()
                                                .equals(userToGetTest.getCryptoWalletAddress())));
        ...
        void testFindByHashUserFile(User user) {
                ...
                User userToGet = ((this.userRepository.findByHashUserFile((userToSave.getHashUserFile())))
                                .orElse(null));
        ...
        void testUpdateCryptoWalletAddress(User user, String newWallet) {
                ...
                assertNotNull(userAfterUpdate);
                assertNotEquals(userBeforeUpdate, userAfterUpdate);
                assertNotEquals((userBeforeUpdate.getCryptoWalletAddress()),
                                (userAfterUpdate.getCryptoWalletAddress()));
        ...
        @ValueSource(strings = { "0xwoCOwKC0q2CjonLNclD112eCQ1d1ScvAcAfar211rfa",
                        "0xwoCOwKC0q2CjIJbncv012cee234rtlD112eCQd1ScvAcAfar211rfa",
                        "0xWWsacCwwvZ012e8C81xXqu12D31r1fDqwd" })
